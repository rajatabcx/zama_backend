...
<body>
    ...
    <div class="outerContainer" style="padding: 16px;">
        <div class="container">
            ...
            <div style="padding:16px;">
                <h1 style="font-size: 24px;margin-bottom: 24px;text-align: center;">
                    Stay Connected: Subscribe for Text Updates!
                </h1>
                <p style="font-size: 14px;margin-bottom: 8px;">Hey there,</p>
                <p style="font-size: 14px;margin-bottom: 8px;">Please provide your phone number in the following
                    format: [Country Code] [Area Code] [Phone Number], for example, +1 555 123 4567.</p>
                <p style="font-size: 14px;margin-bottom: 8px;">Your phone number will only be used for communication
                    related to this form's purpose and will not be shared with third parties.</p>
                <p style="font-size: 14px;margin-bottom: 8px;">Ensure the number you provide is active and accessible as
                    we may need to contact you for verification or updates regarding your submission.</p>
            ...
            <div class="interactive">
                <div class="interactiveInner">
                    <div style="padding: 16px;border-bottom: 1px solid #ebebeb;">
                        <h1 style="font-size: 20px;font-weight: 500;">Subscribe below to get 20% Off</h1>
                    </div>
                    <div style="padding:16px">
                        <form method="post" action-xhr="{submitNumberLink}">
                            <div>
                                <label for="phone" style="margin-bottom:8px;display: block;">Phone Number</label>
                                <input type="string" name="number" id="phone" placeholder="Phone Number" required>
                            </div>

                            <button class="btn" style="margin-top: 16px;">Subscribe</button>
                        </form>
                    </div>
                </div>
            </div>
...
export const phoneNumberFallbackTemplate = `
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="outerContainer">
        <div class="container">
            <div style="padding:16px;">
                <div>
                    <h1 style="margin-bottom: 16px;">Hi</h1>
                    <p style="margin-bottom: 8px;">Hi, This is the fallback for phone number collection form</p>
                </div>
            </div>
        </div>
